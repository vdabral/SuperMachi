          ...
          <div className="mt-8">
            ...
            {reportedPosts.length === 0 ? (
              ...
              reportedPosts.map((post) => (
                <div
                  key={post.id}
                  className="bg-red-100 dark:bg-red-900 p-4 rounded-lg mb-4 shadow-md"
                >
                  <h4 className="text-lg font-semibold text-red-900 dark:text-white">
                    {post.title}
                  </h4>
                  ...
                  <button
                    onClick={() => handleDeletePost(post.id)}
                    className="mt-3 bg-red-600 hover:bg-red-800 text-white px-4 py-2 rounded-lg transition"
                  >
                    Remove Post
                  </button>
                </div>
